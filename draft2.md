...
4.4 Final Dome Construction Prototype . . . . . . . . . . . . . . . . . . . 27
...
the sun moves across the sky [29]. The Degree of Polarisation (DoP) reaches its
...
Figure 4.2: Image of constructed dome

4.2 DOME GEOMETRY AND FABRICATION

26

Figure 4.3: gore template, sheet layout, and assembled hemisphere from the dome
cutting guide.
...
Figure 4.4: Final Dome Construction Prototype
...
skylight to keep their direction when moving. The goal was to develop a system

that was relatively simple and inexpensive to translate this biological principle into

the field of optics, using a fisheye camera and passive polarising material. A whole

geometric structure was created to link the position of the Sun with the picture cap-

tured by the camera. This involved development of a solar-position model for Turku,

an equidistant fisheye projection, an equidistant model of sky polarisation (Rayleigh

sky) and a model of the transmission of polarized light through the polarizing op-

tic. It was seen that both a flat polarising filter and a hemispherical dome made of

polarising-film gores with radially oriented transmission axes could be considered.

A prototype was built and tested in camera to establish the image-acquisition chain

and to obtain a realistic measure of the angular sampling of the lens. A preliminary

development tool was synthetic data was considered. The estimator was found to

produce very small errors for the clear-sky and thin-cloud simulations, but its per-

formance decreased significantly in the heavy-cloud simulation. The mean errors

reported were 0.075◦ for the clear flat-filter case, 0.984◦ for thin cloud, and 16.259◦

for heavy cloud, with just 60% of the heavy-cloud estimates within 5. These are

CHAPTER 8. CONCLUSION

48

results obtained according to the assumptions of the forward model, and should

not be interpreted as the accuracy of the physical compass that will be completed.

The thesis also acknowledges that the actual observations are also influenced by

the alignment of the camera, response of the camera’s sensor, optical properties,

atmospheric scattering, clouds, haze etc. which cannot be completely simulated.

Additional significant limitations were also identified. Ambiguity in the polarisation

pattern, the necessity of using some polarised skylight, and the direct relation be-

tween the camera’s heading and the azimuth in the method all lead to ambiguity

in the reported azimuth. Furthermore, the present confidence measure, which is de-

rived from the sharpness of the peak of the correlation, is not consistently different

for successful estimates and failed estimates, and thus is not effective for rejection of

the measurement or weighting in sensor fusion. It is noteworthy that the evaluation

takes place in a high-latitude setting, which offers a unique evaluation context for

Turku. The Sun elevation is only around 53° in the summer season used in this the-

sis and the Sun is seen almost over the entire compass circle, so the system should

perform throughout a large part of the compass circle without a close passage of

the Sun to the Zenith. This further emphasizes the need to test celestial-navigation

devices in the solar geometry of the site on which they will be used, not on lower

latitude conditions. Overall, the thesis provides the theoretical, computational and

physical basis for a bio-inspired sky compass, instead of showing a fully validated

replacement for any existing navigation sensors. It also illustrates the possibility of

integrating solar geometry, skylight polarisation, fisheye imaging and a passive po-

larising optic into a single heading-estimation system and provides insight into the

challenges of transitioning from simulation to a physical outdoor system. For future

work, the extended outdoor test should be made, improvement of the ambiguity

and confidence estimation of the sky compass, camera tilt correction and fusion of

the sky compass and IMU so that the sky compass can give an absolute heading

CHAPTER 8. CONCLUSION

49

reference to constrain the inertial drift. These directions are already present in the

future work section of the thesis.
